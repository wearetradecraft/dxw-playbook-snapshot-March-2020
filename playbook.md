...
to get things done. So what’s written here is the way we doing things now. Until we find something better, and
write that down.

dxw now encompasses dxw digital and dxw cyber. Many of the values and ways of working are the same across both businesses and so we have one Playbook for both, with any differences marked.
...
These principles help us help us live up to our [values](#values), and guide our behaviour and decision making in all the things we do at dxw.
